...
?>
		...
		$cek_pendaftaran=mysql_query("SELECT b.perkara_id, b.nomor_perkara, b.tanggal_pendaftaran, a.jurusita_id, a.jurusita_nama FROM sipp.perkara_jurusita a INNER JOIN sipp.perkara b ON a.perkara_id = b.perkara_id WHERE a.tanggal_penetapan='".date('Y-m-d')."'");
...
$a=$no_telpon_pp[$r['jurusita_id']];
$pesan="Info SIPP - Perkara Baru Nomor $r[nomor_perkara] Tanggal Pendaftaran $tanggal1 untuk Jurusita Pengganti ".$r['jurusita_nama'];
